...
const binp = path.join(cargoDir, "bin", "prepare_swagger");

if (fs.existsSync(binp)) {
  console.log("Uninstalling prepare_swagger...");
  exec(`cargo uninstall prepare_swagger`, (error, stdout, stderr) => {
    console.log(stdout);
    if (error || stderr) {
  ...
  console.log("prepare_swagger not found skipping!");
}
